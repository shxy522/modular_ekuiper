...
The number of decimal places for generated values. The default is 0, which keeps the generated values as integers. For example, 1 generates values with one decimal place.
